...
/**
 * <p>重构{@link LogbackMDCAdapter}类，使用TransmittableThreadLocal实现父子线程之间的数据传递</p>
 *
 * @author lanlanhappy 2021/04/10 4:36 下午
 */
@SuppressWarnings("all")
public class HappyMDCAdapter implements MDCAdapter {
